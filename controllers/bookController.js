...
exports.book_create_post = [
    ...
    (req, res, next) => {
    	...
    	//Create a Book object width escaped and trimmed data.
    	var book = new Book({
    	...
    	if(!errors.isEmpty()){
    		//There are errors. Render form again width sanitized values/error messages.
...
exports.book_update_get = function(req, res, next) {
    //Get book, author and genres for form.
    async.parallel({
    	book: function(callback){
    		Book.findById(req.params.id).populate('author').populate('genre').exec(callback);
    	},
