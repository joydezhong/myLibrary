...
exports.author_create_post = [
	...
	sanitizeBody('date_of_brith').toDate(),
	...
	(req, res, next) => {
		...
		if(!errors.isEmpty()){
			//There are errors. Render form again width sanitized values/errors messages.
			res.render('author_form', {title: 'Create Author', author: req.body, errors: errors.array()});
			return;
		}else{
			//Data from form is valid.
			
			//Create an Author object width escaped and trimmed data.
